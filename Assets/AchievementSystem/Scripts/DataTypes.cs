...
public struct AchievementInfromation
{
    ...
    [SerializeField] public bool SpoilerUnlocked;           //Hide from player until unlocked
    [SerializeField] public string UnspoilAfterUnlock;      //Name used to unlock achievement
...
public class AchievementState
{
    ...
    [SerializeField] public bool Unlocked = false;      //Is the achievement unlocked
}
